...
-- =====================================================
INSERT INTO persona (id, nombre, apellido, dni, fechaNacimiento, direccion, telefono, email, activo) VALUES
-- Patients (ID 1-20)
(1, 'Juan', 'Pérez', 12345678, '1980-05-10', 'Calle Falsa 123, Buenos Aires', '555-1234', 'juan.perez@email.com', true),
(2, 'María', 'Gómez', 87654321, '1990-08-22', 'Avenida Siempre Viva 742, CABA', '555-5678', 'maria.gomez@email.com', true),
(3, 'Carlos', 'López', 11223344, '1975-12-01', 'Calle Salud 55, Rosario', '555-1111', 'carlos.lopez@email.com', true),
(4, 'Ana', 'Martínez', 22334455, '1985-03-15', 'Rivadavia 1000, La Plata', '555-2222', 'ana.martinez@email.com', true),
(5, 'Roberto', 'Fernández', 33445566, '1970-07-08', 'San Martín 500, Córdoba', '555-3333', 'roberto.fernandez@email.com', true),
(6, 'Laura', 'Rodríguez', 44556677, '1992-11-30', 'Belgrano 200, Mendoza', '555-4444', 'laura.rodriguez@email.com', true),
(7, 'Miguel', 'García', 55667788, '1988-04-12', 'Sarmiento 750, Tucumán', '555-5555', 'miguel.garcia@email.com', true),
(8, 'Carmen', 'Hernández', 66778899, '1983-09-25', 'Mitre 300, Salta', '555-6666', 'carmen.hernandez@email.com', true),
(9, 'Diego', 'Moreno', 77889900, '1978-01-18', 'Urquiza 450, Neuquén', '555-7777', 'diego.moreno@email.com', true),
(10, 'Patricia', 'Jiménez', 88990011, '1995-06-03', 'Alberdi 600, Bahía Blanca', '555-8888', 'patricia.jimenez@email.com', true),
(11, 'Fernando', 'Torres', 99001122, '1987-12-14', 'Roca 800, Mar del Plata', '555-9999', 'fernando.torres@email.com', true),
(12, 'Isabel', 'Ruiz', 11002233, '1981-02-28', 'Pueyrredón 350, San Juan', '555-0000', 'isabel.ruiz@email.com', true),
(13, 'Ricardo', 'Díaz', 22003344, '1973-10-07', 'Rawson 900, Santa Fe', '555-1112', 'ricardo.diaz@email.com', true),
(14, 'Elena', 'Morales', 33004455, '1989-05-20', 'Lavalle 250, Paraná', '555-2223', 'elena.morales@email.com', true),
(15, 'Alberto', 'Castro', 44005566, '1976-08-11', 'Pellegrini 700, Resistencia', '555-3334', 'alberto.castro@email.com', true),
(16, 'Sofía', 'Ortiz', 55006677, '1993-03-26', 'Independencia 400, Corrientes', '555-4445', 'sofia.ortiz@email.com', true),
(17, 'Héctor', 'Silva', 66007788, '1984-07-19', 'Libertad 550, Posadas', '555-5556', 'hector.silva@email.com', true),
(18, 'Natalia', 'Cruz', 77008899, '1991-11-02', 'San Lorenzo 650, Formosa', '555-6667', 'natalia.cruz@email.com', true),
(19, 'Oscar', 'Flores', 88009900, '1986-04-09', 'Entre Ríos 750, Santiago del Estero', '555-7778', 'oscar.flores@email.com', true),
(20, 'Verónica', 'Reyes', 99000011, '1979-12-31', 'Catamarca 850, Jujuy', '555-8889', 'veronica.reyes@email.com', true),
(21, 'Dr. Alejandro', 'González', 11111111, '1975-03-15', 'Av. Corrientes 1500, CABA', '555-1001', 'alejandro.gonzalez@hospital.com', true),
(22, 'Dra. Beatriz', 'Ramírez', 22222222, '1980-07-22', 'Belgrano 800, CABA', '555-1002', 'beatriz.ramirez@hospital.com', true),
(23, 'Dr. Claudio', 'Morales', 33333333, '1978-11-08', 'Palermo 1200, CABA', '555-1003', 'claudio.morales@hospital.com', true),
(24, 'Dra. Diana', 'Vargas', 44444444, '1982-04-30', 'Recoleta 600, CABA', '555-1004', 'diana.vargas@hospital.com', true),
(25, 'Dr. Eduardo', 'Soto', 55555555, '1973-09-12', 'Villa Crespo 900, CABA', '555-1005', 'eduardo.soto@hospital.com', true),
(26, 'Enf. Fabiana', 'Luna', 66666666, '1985-01-25', 'Caballito 1100, CABA', '555-1006', 'fabiana.luna@hospital.com', true),
(27, 'Enf. Gabriel', 'Herrera', 77777777, '1987-06-18', 'Flores 700, CABA', '555-1007', 'gabriel.herrera@hospital.com', true),
(28, 'Enf. Helena', 'Cortés', 88888888, '1989-12-03', 'Villa Devoto 500, CABA', '555-1008', 'helena.cortes@hospital.com', true),
(29, 'Enf. Ignacio', 'Paredes', 99999999, '1984-08-14', 'Villa Pueyrredón 800, CABA', '555-1009', 'ignacio.paredes@hospital.com', true),
(30, 'Enf. Julia', 'Rojas', 10101010, '1990-02-28', 'Villa Urquiza 400, CABA', '555-1010', 'julia.rojas@hospital.com', true),
(31, 'Adm. Kevin', 'Mendoza', 20202020, '1986-05-07', 'Villa Ortúzar 300, CABA', '555-1011', 'kevin.mendoza@hospital.com', true),
(32, 'Adm. Lucía', 'Aguilar', 30303030, '1988-10-20', 'Villa General Mitre 600, CABA', '555-1012', 'lucia.aguilar@hospital.com', true),
(33, 'Adm. Marcos', 'Valdez', 40404040, '1983-03-11', 'Villa Santa Rita 450, CABA', '555-1013', 'marcos.valdez@hospital.com', true),
(34, 'Adm. Nora', 'Campos', 50505050, '1981-07-04', 'Villa del Parque 750, CABA', '555-1014', 'nora.campos@hospital.com', true),
(35, 'Adm. Omar', 'Ríos', 60606060, '1987-12-16', 'Villa Luro 550, CABA', '555-1015', 'omar.rios@hospital.com', true);

-- =====================================================
-- EMPLEADO DATA (Base for medical staff)
-- =====================================================
INSERT INTO empleado (id, salario, cargo, fechaContratacion) VALUES
-- Doctors (ID 21-25)
...
-- =====================================================
INSERT INTO medico (id, especialidad, numMatricula) VALUES
...
(26, 'FACTURACION', 'MAÑANA'),
(27, 'RECEPCION', 'TARDE'),
(28, 'RRHH', 'NOCHE'),
(29, 'ADMINISTRACION', 'MAÑANA'),
...
-- =====================================================
INSERT INTO historial_medico (idHistorial) VALUES 
...
-- =====================================================
INSERT INTO pacientes (id, grupoSanguineo, alergias, historialMedico, historial_id) VALUES
...
-- =====================================================
INSERT INTO consulta (idConsulta, fechaConsulta, horaConsulta, motivo, diagnostico, tratamientoIndicado, medico_id, paciente_id, historial_id) VALUES
